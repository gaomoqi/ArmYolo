...
def process_data(image_file, robot_file, output_dir="cleaned_data"):
    ...
    robot_selected = pd.read_csv(robot_file,sep=r'\s+')
    # 选择需要的列
    ...
    # 横向合并两个数据集
    aligned_data = pd.concat([image_selected, robot_selected], axis=1)
...
if __name__ == "__main__":
    image_file = './data_2025_2_19/image_data_2025_02_19_18_20.csv'
    robot_file = './data_2025_2_19/robot_data_2025_02_19_18_20.csv'
